        ...
        foreach ($data as $value) {
            ...
            if ($value['store_id'] == 0) {
                ...
                $dataBrand = array(
                    ...
                    'is_sold' => $value['sold'],
                    'is_bestseller' => $value['bestseller'],
                    'is_slider' => $value['slider'],
...
//                echo $exc->getTraceAsString();
                ...
                if (!$value['default_sold']) {
                    $this->saveStoreValue($modelBrand, $value['store_id'], 'is_sold', $value['sold']);
                }

                if (!$value['default_bestseller']) {
                    $this->saveStoreValue($modelBrand, $value['store_id'], 'is_bestseller', $value['bestseller']);
                }

                if (!$value['default_slider']) {
                    $this->saveStoreValue($modelBrand, $value['store_id'], 'is_slider', $value['slider']);
                }
