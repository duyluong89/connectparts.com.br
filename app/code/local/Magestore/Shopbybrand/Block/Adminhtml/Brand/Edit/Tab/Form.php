...
class Magestore_Shopbybrand_Block_Adminhtml_Brand_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('image', 'image', array(
            'label'     =>  Mage::helper('shopbybrand')->__('Image'),
            'required'  =>  false,
            'name'      =>  'image',
        ...
        $fieldset->addField('thumbnail_image', 'image', array(
            'label'     =>  Mage::helper('shopbybrand')->__('Thumbnail Image'),
            'required'  =>  false,
        ...
        $fieldset->addField('is_sold', 'select', array(
            'label'     => Mage::helper('shopbybrand')->__('Is Sold'),
            'name'      => 'is_sold',
            'values'    => array(
                array(
                    'value'     => 1,
            ...
            'disabled'  => ($inStore && !$data['is_sold_in_store']),
            'after_element_html' => $inStore ? '</td><td class="use-default">
            <input id="is_sold_default" name="is_featured_default" type="checkbox" value="1" class="checkbox config-inherit" '.($data['is_sold_in_store'] ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
            <label for="is_sold_default" class="inherit" title="'.$defaultTitle.'">'.$defaultLabel.'</label>
          </td><td class="scope-label">
            ['.$scopeLabel.']
          ' : '</td><td class="scope-label">
            ['.$scopeLabel.']',
        ...
        $fieldset->addField('is_bestseller', 'select', array(
                    'label'     => Mage::helper('shopbybrand')->__('Is Best Sellers'),
                    'name'      => 'is_bestseller',
                    'values'    => array(
                        array(
                            'value'     => 1,
                    ...
                    'disabled'  => ($inStore && !$data['is_bestseller_in_store']),
                    'after_element_html' => $inStore ? '</td><td class="use-default">
                    <input id="is_bestseller_default" name="is_bestseller_default" type="checkbox" value="1" class="checkbox config-inherit" '.($data['is_bestseller_in_store'] ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
                    <label for="is_bestseller_default" class="inherit" title="'.$defaultTitle.'">'.$defaultLabel.'</label>
                  </td><td class="scope-label">
                    ['.$scopeLabel.']
                  ' : '</td><td class="scope-label">
                    ['.$scopeLabel.']',
                ));
        $fieldset->addField('is_slider', 'select', array(
                    'label'     => Mage::helper('shopbybrand')->__('Show on slider homepage'),
                    'name'      => 'is_slider',
                    'values'    => array(
                        array(
                            'value'     => 1,
                    ...
                    'disabled'  => ($inStore && !$data['is_slider_in_store']),
                    'after_element_html' => $inStore ? '</td><td class="use-default">
                    <input id="is_slider_default" name="is_slider_default" type="checkbox" value="1" class="checkbox config-inherit" '.($data['is_slider_in_store'] ? '' : 'checked="checked"').' onclick="toggleValueElements(this, Element.previous(this.parentNode))" />
                    <label for="is_slider_default" class="inherit" title="'.$defaultTitle.'">'.$defaultLabel.'</label>
                  </td><td class="scope-label">
                    ['.$scopeLabel.']
                  ' : '</td><td class="scope-label">
                    ['.$scopeLabel.']',
